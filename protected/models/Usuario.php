...
class Usuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('correo', 'email'),			
			array('sitioweb', 'url',  'message'=>'Por favor usa un URL valido enter a value for {attribute}.'),
			array('usuario, correo', 'unique', 'caseSensitive'=>false ),
			array('telefono', 'length','max'=>15),
			
			
			
array('foto_perfil', 'length', 'max' => 255, 'tooLong' => '{attribute} el nombre del archivo es muy largo (max {max} caracteres).', 'on' => 'create, insert,upload'),

array('foto_perfil', 'file', 'types' => 'jpg,jpeg,gif,png', 'allowEmpty'=>true, 'maxSize' => 1024 * 1024 * 2, 'tooLarge' => 'La foto debe ser menor a 2MB !!!', 'on' => 'create, insert, upload'),
